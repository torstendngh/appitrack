...
const features = [
  {
    ...
    proFeature: "Unlimited applications",
    free: true,
    pro: true,
  },
    ...
    <div className={styles.main}>
      ...
      <div className={styles.thirdsContainer}>
        <Tier
          title={"Free"}
          description={
            "For anyone who needs a simple application tracker tool. Free forever."
          }
          price={"0,-"}
        ...
        <Tier
          title={"Pro"}
          description={
            "Advanced features for advanced users and support the developers."
          }
          price={"4,99"}
          isPrimary
